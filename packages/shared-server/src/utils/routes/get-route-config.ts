import { getStringParts } from '../../utils/strings.js';

export function getRouteConfig(routeConfig, state) {
 ...
 */
function findRouteConfig(config, pathParts: string[]) {
 ...
 * @param pathParts
 */
function getBasePathFilter([rootPath = '']: string[]) {

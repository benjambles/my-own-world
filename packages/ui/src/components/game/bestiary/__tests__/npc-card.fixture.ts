import { NPCCard } from '@benjambles/mow-game/lib/types/game/npc.js';
    ...
    actions: {
        ...
        special: {
            a: {
                ...
                type: 'A',
                range: 1,
                effect: 'Deal 1d10 + 10 Damage VS . Hero cannot take Move Actions until the end of next Turn.',
            },
            b: {
            ...
            c: {
                name: 'Huff Pixie',
                type: 'C',
                effect: '+10   until start of next Turn and remove 1 Sustained Effect from Doorcrasher. Lose 10 HP.',
            },
            d: {
        ...
        learnable: {
            e: {
                ...
                type: 'E',
                range: 1,
                effect: 'Deal 2d10 + 10 Damage VS  and Hero is pushed directly away 5 Squares (if possible). All other Heroes adjacent to pushed Target during or when the Forced Movement ends take 5 PIERCING Damage.',
            },
            f: {
                name: 'Savage Slash VS [Acrobatics OR Endurance]',
                type: 'F',
                range: 1,
                effect: 'Trig. Cond: If an adjacent Hero uses a Basic Attack or Exploit, Trig. Effect: Doorcrasher makes a Basic Attack before that Hero’s Action is completed. If the Attack hits, deal Basic Attack Damage and Cancel that Hero’s Action.',
            },
        },
    },
};

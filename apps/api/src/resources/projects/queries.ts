 ...
 */
export async function getActiveProjectByUuid(projects, uuid): Promise<Project.ProjectData> {
 ...
 * @param uuid - A valid uuid
 */
export async function deleteProject(projects, uuid): Promise<boolean> {
